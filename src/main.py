...
from datasets.dataset.kitti import KITTI
...
class COCO_Dataset(data.Dataset):
    ...
    def __init__(self, opt, split):
        ...
        catIds = self.coco.getCatIds(catNms=['car','bus','truck'])
        self.images = self.coco.getImgIds(catIds=catIds)
...
def main(opt):
  ...
  opt.data_dir='/kaggle/working/../input/coco-2017-dataset/coco2017'
  print(opt)
